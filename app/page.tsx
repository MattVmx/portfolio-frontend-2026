...
const projects: Project[] = [
  ...
  },
  {
    ...
    summary: { es: "Una experiencia de hospedaje inspirada en la Patagonia, con contenido bilingüe, tema claro u oscuro y gestión desde WordPress.", en: "A Patagonia-inspired hospitality experience with bilingual content, light and dark themes, and WordPress-powered management." },
    outcome: { es: "Un sitio cálido y fácil de recorrer donde las estadías y las consultas pueden administrarse sin tocar el código.", en: "A warm, easy-to-browse site where stays and inquiries can be managed without touching the code." },
    highlights: {
      es: ["Tema de WordPress hecho a medida", "Alojamientos editables desde el panel", "Consultas guardadas en WordPress"],
      en: ["Custom-built WordPress theme", "Stays editable from the dashboard", "Inquiries stored in WordPress"],
    },
